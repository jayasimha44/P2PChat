...
import com.example.kulverstukas.p2pchat.adapters.HistoryAdapter;
...
public class MainActivity extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!this.sp.contains(Constants.USER_NAME)){
    ...
    public void file_share(View view){
    Intent intent1 = new Intent(MainActivity.this, WiFiDirectActivity.class);
    intent1.putExtra(Constants.USER_NAME, username);// Only accept from this number?
