...
/**
 * Created by kulverstukas on 15/2/17.
 */
...
import utils.LogRTCListener;

import com.example.kulverstukas.p2pchat.adapters.ChatAdapter;
import com.example.kulverstukas.p2pchat.adt.ChatMessage;
import com.example.kulverstukas.p2pchat.adt.HistoryItem;
import com.example.kulverstukas.p2pchat.servers.XirSysRequest;
...
public class VideoChatActivity extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       VideoCapturer cap = VideoCapturerAndroid.create(frontFacingCam);
        // First create a Video Source, then we can make a Video Track
        localVideoSource = pcFactory.createVideoSource(cap, this.pnRTCClient.videoConstraints());
